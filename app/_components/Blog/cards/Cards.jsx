...
const Cards = ({
  ...
  // Filter cards by category and search query (search only in category)
    ...
    <div className="bg-black text-white myContainer topContainer transition-all duration-300">
      ...
      <div className="text-center">
        <SectionContent
          ...
          heading={heading}
          hedingClass="text-4xl md:text-5xl font-serif font-bold tracking-tight"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {displayedCards.map(card => (
          ...
          >
            ...
            <div className="p-5">
              <h3 className="text-xl md:text-2xl font-semibold text-yellow-300 mb-2">{card.category}</h3>
